...
from packages.kivymd_templates.dialogs import ShowOptions, ConfirmChoice, GrantAccess
from packages.kivymd_templates.listitems import TableRow
from packages.kivymd_templates.buttons import MyIconTextButton
...
class SelectFile(MyScreen):
    ...
    def check_file(self):
        ...
        directory = ChD.get_running_app().get_setting('import_directory')
        if is_file:
    ...
    def check_file_format(self):
        ...
        # if file_format in ['pleco','jsonl','all']:
