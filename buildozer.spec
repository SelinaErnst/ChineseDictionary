...
requirements = python3==3.11.1, hostpython3==3.11.1, kivy==2.3.1, https://github.com/kivymd/KivyMD/archive/master.zip, plyer==2.1.0, requests, pillow, pyjnius, exceptiongroup, asynckivy, asyncgui, materialyoucolor, android, typeguard, typing_extensions
...
android.permissions = android.permission.INTERNET, android.permission.ACCESS_NETWORK_STATE, android.permission.READ_MEDIA_IMAGES, android.permission.READ_MEDIA_VIDEO, android.permission.READ_MEDIA_AUDIO, android.permission.READ_EXTERNAL_STORAGE, android.permission.MANAGE_EXTERNAL_STORAGE, (name=android.permission.WRITE_EXTERNAL_STORAGE;maxSdkVersion=18)
